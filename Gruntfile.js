...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        buildcontrol: {
        	...
        	pages: {
        		options: {
        			remote: 'git@github.com:NovaCreatorSoftware/bootstrap-tree.git',
        			branch: 'gh-pages'
        		}
        	},
        	/*heroku: {
    ...
    grunt.registerTask('build', ['clean:build', 'version', 'less', 'copy', 'bower_concat', 'concat', 'csslint', 'jshint']); 
